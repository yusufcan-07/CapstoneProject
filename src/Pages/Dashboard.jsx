...
const Dashboard = () => {
  ...
  return (
    <div className="container mx-auto mt-4 flex flex-col">
      ...
      <div className="w-full h-full rounded-md relative p-8 border-2 bg-white mt-12 flex flex-row items-center">
      ...
      <div className="flex flex-row ">
        <div className=" w-full h-full rounded-md relative p-8 border-2 bg-white mt-4 mr-4 flex-0 ">
          {/* <img
        ...
        <div className=" w-full h-full rounded-md relative p-8 border-2 bg-white mt-4 ml-4 flex-1 ">
          <Watchlist stocks={stocksData} onAddStock={handleAddStock} />
        </div>
      </div>
      <div></div>
    </div>
